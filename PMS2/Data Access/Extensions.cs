...
namespace PMS.Data_Access
{
    ...
    {
        public static Guid GetGuid(this System.Data.IDataRecord record, string fieldname)
        {
        ...
        public static string GetDate(this System.Data.IDataRecord record, string fieldname)
        {
            object value = record[fieldname];
            ...
            return string.Format("{0:dd-MMM-yyyy}", date).ToUpper();
        }
        ...
        public static decimal GetDecimal(this System.Data.IDataRecord record, string fieldname)
        {
            return GetDecimal(record, fieldname, 0);
        }

        public static decimal GetDecimal(this System.Data.IDataRecord record, string fieldname, decimal defaultIfNull)
        {
            object value = record[fieldname];
            ...
            if (value is decimal)
                ...
                return value == DBNull.Value ? defaultIfNull : Convert.ToDecimal(value);
        }
        ...
        public static TimeSpan GetTime(this System.Data.IDataRecord record, string fieldname)
        {
            object value = record[fieldname];
            ...
            if (value is TimeSpan)
                ...
                return ((value == DBNull.Value) ? TimeSpan.MinValue : TimeSpan.Parse(value.ToString()));
        }
        ...
        public static byte GetByte(this System.Data.IDataRecord record, string fieldname)
        {
            return GetByte(record, fieldname, 0);
        }

        public static byte GetByte(this System.Data.IDataRecord record, string fieldname, byte defaultIfNull)
        {
            object value = record[fieldname];
            ...
            if (value is byte)
                ...
                return value == DBNull.Value ? defaultIfNull : Convert.ToByte(value);
        }
        ...
        #endregion Preferences Extensions
    }
}